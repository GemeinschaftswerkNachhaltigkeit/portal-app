...
public class MapSearchController {
    ...
    public Page<MapSearchResultWrapperDto> searchMap(
        ...
        final BooleanBuilder searchPredicate =
                getSearchPredicate(envelope, query, location, organisationTypes, activityTypes,
                        includeExpiredActivities, includeNoCoords, mapSearchFilterPredicate);
    ...
    private BooleanBuilder getSearchPredicate(Envelope envelope, String query, String location,
        ...
        if (Objects.nonNull(activityTypes) && !activityTypes.isEmpty()) {
            gotTypePredicate = true;
            typePredicate.or(
                    QMapSearchResult.mapSearchResult.activityType.in(activityTypes)
            );
        }
    ...
    private BooleanExpression orInThematicFocus(String query, BooleanExpression searchFieldsForQuery) {
        ...
        final Set<ThematicFocus> fullTextThematicFocus = fullTextSearchHelper.getMatchingValues(ThematicFocus.class, query);
    ...
    private BooleanExpression orInSdgs(String query, BooleanExpression searchFieldsForQuery) {
        final Set<SustainableDevelopmentGoals> fullTextSdgs = fullTextSearchHelper.getMatchingValues(SustainableDevelopmentGoals.class, query);
    ...
    private BooleanExpression orInOrganisationType(String query, BooleanExpression searchFieldsForQuery) {
        final Set<OrganisationType> fullTextOrganisationTypes = fullTextSearchHelper.getMatchingValues(OrganisationType.class, query);
    ...
    private BooleanExpression orInActivityType(String query, BooleanExpression searchFieldsForQuery) {
        final Set<ActivityType> fullTextActivityTypes = fullTextSearchHelper.getMatchingValues(ActivityType.class, query);
