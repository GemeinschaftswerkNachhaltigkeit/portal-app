...
import com.exxeta.wpgwn.wpgwnapp.marketplace.marketplace_work_in_progress.OfferWorkInProgressValidator;
...
public class BestPracticeWorkInProgressController {
    ...
    private final OfferWorkInProgressValidator offerValidator;
    ...
    public Page<BestPractiseWorkInProgressResponseDto> getBestPractiseItems(
        ...
        return marketplaceWorkInProgressService.findBestPractiseItems(orgId, pageable)
                .map(offerWorkInProgressMapper::mapBestPractiseWorkInProgress);
    }
    ...
    public BestPractiseWorkInProgressResponseDto getMarketPlaceItemById(
        ...
        return offerWorkInProgressMapper.mapBestPractiseWorkInProgress(offerWip);
    }
    ...
    public BestPractiseWorkInProgressResponseDto updateBestPractise(
        ...
        offerWorkInProgressMapper.updateBestPractise(offerRequest, bestPractiseWorkInProgress);
