...
public class ContactInviteDeniedEmailContentGeneratorWithOptOutCheck
        implements ContentGenerator<ContactInvite> {
    ...
    public String generateMailBody(ContactInvite entity) {
        ...
        return templateEngine.process(
                "email/organisation-work-in-progress/contact_invite/organisation-contact-invite-denied",
                context);
    }

    @Override
    public String getSubject() {
        return emailMessageSource.getMessage("organisation-contact-invite-denied-email.subject",
