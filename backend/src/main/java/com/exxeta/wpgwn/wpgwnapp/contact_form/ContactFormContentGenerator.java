...
public class ContactFormContentGenerator {
    ...
    String generateMailBody(ContactFormDto contactFormDto) {
        ...
        return templateEngine.process("email/contact-form/contact-form-email", context);
    }

    String getSubject(@NotNull ContactType contactType) {
        return emailMessageSource.getMessage("contact-form.email.subject", new Object[] {contactType},
                Locale.getDefault());
    }
