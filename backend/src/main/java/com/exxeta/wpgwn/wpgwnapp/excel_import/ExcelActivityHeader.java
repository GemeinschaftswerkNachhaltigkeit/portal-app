...
public enum ExcelActivityHeader implements ExcelHeader {
    ...
    private static ActivityType getActivitytype(String stringCellValue) {
        ...
        try {
            ...
            switch (value) {
                case "BETEILIGUNGSPROZESS": return ActivityType.PARTICIPATION_PROCESS;
                case "FÖRDERPROGRAMM": return ActivityType.FUNDING_PROGRAM;
                case "NETZWERK": return ActivityType.NETWORK;
                case "PROJEKTENTWICKLUNG": return ActivityType.PROJECT_PROGRESS;
