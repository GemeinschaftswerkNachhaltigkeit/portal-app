...
public class MarketplaceService {
    ...
    public Page<Offer> findOffersByOrganisationId(Long orgId, Pageable pageable) {
        final Predicate predicate = QMarketplaceItem.marketplaceItem.organisation.id.eq(orgId)
    ...
    public Page<BestPractise> findBestPractiseByOrganisationId(Long orgId, Pageable pageable) {
        final Predicate predicate = QMarketplaceItem.marketplaceItem.organisation.id.eq(orgId)
