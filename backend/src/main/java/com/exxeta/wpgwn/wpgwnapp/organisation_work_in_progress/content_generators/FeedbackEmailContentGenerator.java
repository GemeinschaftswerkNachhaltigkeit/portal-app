...
@Component
public class FeedbackEmailContentGenerator
        extends AbstractOrganisationWorkInProgressContentGenerator {

    public FeedbackEmailContentGenerator(WpgwnProperties wpgwnProperties,
        ...
        super(wpgwnProperties,
                ...
                keycloakService,
                emailOptOutService,
                "organisation-work-in-progress-feedback-required-email.subject",
                "email/organisation-work-in-progress/feedback/organisation-feedback-required");
    }

    @NonNull
    @Override
    public EmailOptOutOption getEmailOptOutOption() {
        return EmailOptOutOption.COMPANY_WIP_FEEDBACK;
    }
}
