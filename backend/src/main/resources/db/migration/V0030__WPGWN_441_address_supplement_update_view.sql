alter table if exists activity
    add column address_supplement varchar(255),
...
SELECT *
FROM (SELECT FLOOR((ROW_NUMBER() OVER(ORDER BY o1.id)-1)/2)*2 AS cluster_number,
             ...
             o1.address_name, o1.address_street, o1.address_street_no, o1.address_supplement, o1.address_zip_code, o1.address_city, o1.address_state, o1.address_country,
      ...
      GROUP BY o1.id
      UNION ALL
      SELECT (FLOOR((ROW_NUMBER() OVER(ORDER BY a1.id)-1)/2)*2)+1 AS cluster_number,
             ...
             a1.address_name, a1.address_street, a1.address_street_no, a1.address_supplement, a1.address_zip_code, a1.address_city, a1.address_state, a1.address_country,
