...
class OrganisationWorkInProgressServiceTest {
    ...
    @BeforeEach
    void setUp() {
        WpgwnProperties wpgwnProps = new WpgwnProperties(null, null, "null", "null", "null", "test", "test",
        ...
        service = new OrganisationWorkInProgressService(repository, feedbackHistoryRepository, activityWorkInProgressService, fileStorageService,
