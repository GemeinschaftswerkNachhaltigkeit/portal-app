...
class OrganisationWorkInProgressAdminControllerTest {
    ...
    void feedbackRequiredWorkInProgress() throws Exception {
        ...
        organisationWorkInProgress = organisationWorkInProgressRepository.findById(organisationWorkInProgress.getId()).get();
    ...
    void rejectWorkInProgress() throws Exception {
        ...
        assertThat(organisationWorkInProgress.getRejectionReason()).isEqualTo("Die angegebenen Nachhaltigkeitsziele sind nicht nachhaltig genug.");
    }
